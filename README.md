...
For a *visual* representation of pagination view this [file](https://github.com/jxmot/github-graphql-snippets/docs/pagination.html). There is also an accompanying Excel spreadsheet in the `docs` folder in this repository.
